...
func runExample() async {
    ...
    do {
        ...
        print("   • token_endpoint_auth_method: 'none' (for mobile apps)")
...
print("   • Support for token_endpoint_auth_method in registration (RFC 7591)")
print("   • Automatic public client detection for mobile apps")
print("")
