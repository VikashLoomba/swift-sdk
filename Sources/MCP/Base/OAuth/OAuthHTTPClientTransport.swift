...
// MARK: - OAuth Provider Presets

extension OAuthConfiguration {
    /// GitHub OAuth configuration
    public static func github(clientId: String, clientSecret: String, scopes: [String] = []) -> OAuthConfiguration {
    ...
    public static func google(clientId: String, clientSecret: String, scopes: [String] = []) -> OAuthConfiguration {
        return OAuthConfiguration(
    ...
    public static func microsoft(clientId: String, clientSecret: String, scopes: [String] = []) -> OAuthConfiguration {
        return OAuthConfiguration(
